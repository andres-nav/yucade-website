      ...
      <section className="relative block" id="precios">
        ...
        <div className="container mx-auto px-4 lg:pt-24 lg:pb-32">
          <div className="flex flex-wrap text-center justify-center">
            ...
            <div class="flex flex-row text-center pt-12">
              <div class="w-100 p-8 px-12 bg-gray-100 rounded-3xl pr-16 shadow-xl">
                <h1 class="text-black font-semibold text-2xl">Básico</h1>
                <p class="pt-2 tracking-wide">
                  <span class="text-lg text-gray-400 align-top">€‎ </span>
              ...
              <div class="w-100 p-8 bg-gray-900 text-center rounded-3xl text-white shadow-xl transform scale-125">
                <h1 class="text-white font-semibold text-2xl">Startup</h1>
                <p class="pt-2 tracking-wide">
                  <span class="text-lg text-gray-400 align-top">€‎ </span>
                  <span class="text-3xl font-semibold">1000</span>
                  <span class="text-gray-400 font-medium">/ año</span>
                </p>
                <div class="pt-8">
                  <p class="font-semibold text-gray-400 text-left">
                    <span class="pl-2">Lorem ipsum dolor sit amet</span>
              ...
              <div class="w-100 p-8 px-12 bg-white text-center rounded-3xl pl-16 shadow-xl">
                <h1 class="text-black font-semibold text-2xl">Enterprise</h1>
                <p class="pt-2 tracking-wide">
                  <span class="text-lg text-gray-400 align-top">€‎ </span>
                  <span class="text-3xl font-semibold">1500</span>
                  <span class="text-gray-400 font-medium">/ año</span>
                </p>
                <div class="pt-8">
                  <p class="font-semibold text-gray-400 text-left">
